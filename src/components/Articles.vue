<template>
  <section v-if="articles" class="row justify-content-center text-white ">
    <article v-for="(a, i) in articles" :key="i" class="col-12 col-lg-8 text-white ">
      ...
      <div class="row">
        ...
        <div class="col-12 d-flex text-dark">
          <p class="my-auto me-3">
            ...
            <span class="badge bg-success ">{{ a.like }}</span>
          </p>
          <button
            v-if="auth.authentified"
            v-on:click="addLike(a)"
          ...
          <p class="my-auto ms-3">
            ...
            <span class="badge bg-primary">{{ a.commentaires.length }}</span>
          </p>
        </div>
        <div class="col-12">
          <h2>Commentaires :</h2>
